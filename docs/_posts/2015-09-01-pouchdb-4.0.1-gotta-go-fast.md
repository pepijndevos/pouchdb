...
PouchDB now has a [Slack channel](http://slack.pouchdb.com). It's linked to the [IRC channel](irc://irc.libera.chat:6697/#pouchdb), so any messages will show up in both.
